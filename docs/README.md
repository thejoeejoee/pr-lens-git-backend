...
| **How-to** | Doing. [Self-managed GitLab](how-to/self-managed-gitlab.md) · [Deploy with Helm](how-to/deploy-with-helm.md) · [Put a CDN in front](how-to/put-a-cdn-in-front.md) · [Cut a release](how-to/releasing.md) |
